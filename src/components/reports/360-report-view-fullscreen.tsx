          ...
          >
            {noResponsesYet ? (
              ...
              <>
                ...
                <p>
                  Each individual competency score is presented with corresponding rater feedback and suggestions. Your scores are compared to (1) averages for similar jobs/positions and (2) the average of your colleagues (i.e., geonorms) who have also recently completed the 360-degree feedback survey{reportData.client_name ? ` at ${reportData.client_name}` : ''}. Anchoring your scores to industry averages and your company geonorms provides a much more accurate representation of where your scores stand and enhances motivation to accelerate your leadership involvement.
                </p>
              </>
            )}
          </div>
                        ...
                        >
                          ...
                          <div
                            ...
                            style={{
                              ...
                              flexShrink: 0,
                              alignSelf: 'center',
                              backgroundColor: REPORT_COLORS.lightGray,
                              margin: '0 16px',
                            }}
                          />
                          <div
